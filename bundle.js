...
document.addEventListener('DOMContentLoaded', function () {
  (0, _reactDom.render)(_react2.default.createElement(_App2.default, null), document.getElementById('morse'));
});
...
var _MorsePlayer = __webpack_require__(28);

var _MorsePlayer2 = _interopRequireDefault(_MorsePlayer);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint-disable jsx-a11y/audio-has-caption */


var query = 'https://api.wordnik.com/v4/words.json/randomWords?hasDictionaryDef=true&minCorpusCount=0&minLength=3&maxLength=7&limit=1&api_key=a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5';
...
var words = ['shell', 'halls', 'slick', 'trick', 'boxes', 'leaks', 'strobe', 'bistro', 'flick', 'bombs', 'break', 'brick', 'steak', 'sting', 'vector', 'beats'];
...
var _morse_map = __webpack_require__(29);

var _morse_map2 = _interopRequireDefault(_morse_map);
...
var TIME_BETWEEN_LOOPS = 1000;
var FLASH_BEAT_RATIO = [2, 3];

var MorsePlayer = function (_Component) {
  _inherits(MorsePlayer, _Component);

  function MorsePlayer(props) {
    _classCallCheck(this, MorsePlayer);

    var _this = _possibleConstructorReturn(this, (MorsePlayer.__proto__ || Object.getPrototypeOf(MorsePlayer)).call(this, props));
  ...
  _createClass(MorsePlayer, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var prevOn = this.quarterBeats[prevState.curQuarterBeatIdx];
      var isOn = this.quarterBeats[this.state.curQuarterBeatIdx];
    ...
    key: 'getQuarteBeats',
    value: function getQuarteBeats() {
      var morse = this.props.word.toLowerCase().split('').map(function (letter) {
        return _morse_map2.default[letter];
      }).join(' ');
      return this.quarterify(morse);
    }
  }, {
    key: 'quarterify',
    value: function quarterify(morse) {
      var res = [];
      var totalPerBeat = FLASH_BEAT_RATIO[1];
      var onPerBeat = FLASH_BEAT_RATIO[0];
      var offPerBeat = FLASH_BEAT_RATIO[1] - FLASH_BEAT_RATIO[0];

      morse.split('').forEach(function (char) {
        if (char === '.') {
          for (var i = 0; i < onPerBeat; i += 1) {
            res.push(true);
          }for (var _i = 0; _i < offPerBeat; _i += 1) {
            res.push(false);
          }
        } else if (char === '-') {
          for (var _i2 = 0; _i2 < totalPerBeat + onPerBeat; _i2 += 1) {
            res.push(true);
          }for (var _i3 = 0; _i3 < offPerBeat; _i3 += 1) {
            res.push(false);
          }
        } else {
          for (var _i4 = 0; _i4 < totalPerBeat; _i4 += 1) {
            res.push(false);
          }
        }
      });
    ...
    value: function startFlashing() {
      ...
      this.interval = setInterval(function () {
        _this3.setState({
          curQuarterBeatIdx: _this3.state.curQuarterBeatIdx + 1
        });
        if (_this3.state.curQuarterBeatIdx >= _this3.quarterBeats.length - 1) {
          _this3.pause();
    ...
    value: function render() {
      ...
      var onOff = this.isOn() ? 'on' : 'off';
      return _react2.default.createElement(
        'div',
        null,
        !this.props.autoPlay && _react2.default.createElement(
          'button',
          { onClick: this.togglePlay },
